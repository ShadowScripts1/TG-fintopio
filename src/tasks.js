...
async function automaticFlow(BEARERS) {
  while (true) {
    ...
    console.log(
      "📢 While waiting, don't forget to subscribe to https://t.me/shadowscripters for the latest and best airdrops and bots!\n"
        .cyan
    );
...
Enter 1, 2, 3, 4, or 5: `);
    ...
    if (options === '5') {
      ...
      console.log('Subscribe: https://t.me/shadowscripters '.green);
      process.exit(0);
    }
